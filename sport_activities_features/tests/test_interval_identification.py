...
class TestHillIdentification(TestCase):
    ...
    def test_min_heartrate_correct(self):
        self.assertAlmostEqual(self.statistics_heartrate["min_heartrate_interval"], 167.2958, places=4)

    def test_max_heartrate_correct(self):
        self.assertAlmostEqual(self.statistics_heartrate["max_heartrate_interval"], 174.23, places=2)

    def test_avg_heartrate_correct(self):
        self.assertAlmostEqual(self.statistics_heartrate["avg_heartrate_interval"], 170.61, places=2)
