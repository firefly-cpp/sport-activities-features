...
class OverpyNodesReader(object):
    """
    Class for working with Overpass nodes (Overpy.node). The purpose is to generate a dictionary object similar to those
    generated by TCXFile and GPXFile classes.\n
    Args:
        open_elevation_api (str): location of the Open Elevation Api
    """
    def __init__(self, open_elevation_api: str = "https://api.open-elevation.com/api/v1/lookup?") -> None:
        """
        Initialisation method for OverpyNodesReader.\n
        Args:
            open_elevation_api (str): address of Open Elevation API, if a lot of altitudes are needed, self hosting is
            prefferable.
        """
