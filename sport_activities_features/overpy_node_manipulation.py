...
class OverpyNodesReader(object):
    ...
    def read_nodes(self, nodes:overpy.Node, cumulative_distances:bool=True):
        """
        ...
        Args:
            ...
            cumulative_distances: If set to True, distance equals previous point distance + distance between the nodes,
