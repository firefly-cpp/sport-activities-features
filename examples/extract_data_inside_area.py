...
for file in all_files:
    ...
    # Area coordinates should be given in clockwise orientation
    # in the form of a 3D array (number_of_hulls, hull_coordinates, 2).
    # Holes in the area are permitted.
    area_coordinates = np.array([[[45.445539, 13.736101],
                                  [45.566894, 13.700517],
                                  [45.563605, 13.806872],
                                  [45.480111, 13.812463]]])

    # Extracting the data inside of the given area.
    area = AreaIdentification(positions,
                              distances,
                              timestamps,
                              heartrates,
                              area_coordinates)
    ...
    # If at least a part of exercise is inside of the
    # area, the area is added to the array of areas.
